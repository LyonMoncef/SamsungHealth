...
> [!info] Code mirror
> Ce fichier est un **miroir auto-généré** de [`static/auth/oauth-link-confirm.html`](../../../static/auth/oauth-link-confirm.html).
...
<head>
  ...
  <title>Lier un compte Google — Data Saillance</title>
...
<body>
  ...
  <main class="auth-shell">
    <section class="auth-card">
      ...
      <h1 class="auth-title">Lier votre compte Google</h1>
      <p>Confirmation de la liaison en cours...</p>
      <div id="oauth-link-message" aria-live="polite"></div>
