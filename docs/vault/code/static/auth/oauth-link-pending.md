...
> [!info] Code mirror
> Ce fichier est un **miroir auto-généré** de [`static/auth/oauth-link-pending.html`](../../../static/auth/oauth-link-pending.html).
...
<head>
  ...
  <title>Lien envoyé — Data Saillance</title>
...
<body>
  ...
  <main class="auth-shell">
    <section class="auth-card">
      ...
      <h1 class="auth-title">Lien envoyé</h1>
      <p>Un lien de confirmation a été envoyé à votre email. Vérifiez vos messages.</p>
