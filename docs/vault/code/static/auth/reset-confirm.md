...
> [!info] Code mirror
> Ce fichier est un **miroir auto-généré** de [`static/auth/reset-confirm.html`](../../../static/auth/reset-confirm.html).
...
<head>
  ...
  <title>Réinitialiser le mot de passe — Data Saillance</title>
...
<body>
  ...
  <main class="auth-shell">
    <section class="auth-card">
      ...
      <form class="auth-form" id="reset-confirm-form" novalidate>
        <label>Nouveau mot de passe (12 caractères minimum)
          <input type="password" name="new_password" autocomplete="new-password" required minlength="12" maxlength="1024">
        </label>
        <label>Confirmer le mot de passe
          <input type="password" name="confirm_password" autocomplete="new-password" required minlength="12" maxlength="1024">
        </label>
        <button type="submit" class="auth-btn-primary">Réinitialiser</button>
      </form>
      <div id="reset-confirm-message" aria-live="polite"></div>
