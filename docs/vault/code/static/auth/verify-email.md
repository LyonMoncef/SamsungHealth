...
type: code-source
language: html
file_path: static/auth/verify-email.html
git_blob: 3ea9de3202fbcab5c5e5c3043467bebfca219ada
...
> [!info] Code mirror
> Ce fichier est un **miroir auto-généré** de [`static/auth/verify-email.html`](../../../static/auth/verify-email.html).
...
<head>
  ...
  <title>Vérification email — Data Saillance</title>
...
<body>
  ...
  <main class="auth-shell">
    <section class="auth-card">
      ...
      <div id="verify-email-message" aria-live="polite"></div>
