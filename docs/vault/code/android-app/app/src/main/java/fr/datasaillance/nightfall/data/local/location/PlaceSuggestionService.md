...
type: code-source
language: kotlin
file_path: android-app/app/src/main/java/fr/datasaillance/nightfall/data/local/location/PlaceSuggestionService.kt
git_blob: c33c92a8adcbe10c38666325c80d007d70b770ff
...
# android-app/app/src/main/java/fr/datasaillance/nightfall/data/local/location/PlaceSuggestionService.kt

> [!info] Code mirror
> Ce fichier est un **miroir auto-généré** de [`android-app/app/src/main/java/fr/datasaillance/nightfall/data/local/location/PlaceSuggestionService.kt`](../../../android-app/app/src/main/java/fr/datasaillance/nightfall/data/local/location/PlaceSuggestionService.kt).
...
### Symbols
- `PlaceSuggestion` (class) — lines 10-17
- `computeSuggestions` (function) — lines 41-53
- `MutableCluster` (class) — lines 55-81
- `add` (function) — lines 66-72
- `toSuggestion` (function) — lines 74-80
