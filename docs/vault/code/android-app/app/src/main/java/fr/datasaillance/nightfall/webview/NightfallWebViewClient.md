...
type: code-source
language: kotlin
file_path: android-app/app/src/main/java/fr/datasaillance/nightfall/webview/NightfallWebViewClient.kt
git_blob: fe47a6c80ad53b128582fb287ae9c658609b1186
...
# android-app/app/src/main/java/fr/datasaillance/nightfall/webview/NightfallWebViewClient.kt

> [!info] Code mirror
> Ce fichier est un **miroir auto-généré** de [`android-app/app/src/main/java/fr/datasaillance/nightfall/webview/NightfallWebViewClient.kt`](../../../android-app/app/src/main/java/fr/datasaillance/nightfall/webview/NightfallWebViewClient.kt).
...
### Symbols
- `NightfallWebViewClient` (class) — lines 16-82
- `shouldOverrideUrlLoading` (function) — lines 22-41
- `onPageFinished` (function) — lines 43-47
- `injectAuth` (function) — lines 49-54
- `injectTheme` (function) — lines 56-63
- `onReceivedSslError` (function) — lines 65-69
- `onReceivedHttpError` (function) — lines 71-81
