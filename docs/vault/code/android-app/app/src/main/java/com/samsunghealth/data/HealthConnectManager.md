...
> [!info] Code mirror
> Ce fichier est un **miroir auto-généré** de [`android-app/app/src/main/java/com/samsunghealth/data/HealthConnectManager.kt`](../../../android-app/app/src/main/java/com/samsunghealth/data/HealthConnectManager.kt).
...
### Symbols
- `SleepStageData` (class) — lines 17-21
- `SleepSessionData` (class) — lines 23-27
- `StepsHourlyData` (class) — lines 29-33
- `HeartRateHourlyData` (class) — lines 35-42
- `ExerciseSessionData` (class) — lines 44-49
- `HealthConnectManager` (class) — lines 51-188
- `getSdkStatus` (function) — lines 64-64
- `hasAllPermissions` (function) — lines 66-69
- `readSleepSessions` (function) — lines 71-92
- `readSteps` (function) — lines 94-119
- `readHeartRate` (function) — lines 121-150
- `readExerciseSessions` (function) — lines 152-168
- `mapStageType` (function) — lines 170-176
- `mapExerciseType` (function) — lines 178-187
