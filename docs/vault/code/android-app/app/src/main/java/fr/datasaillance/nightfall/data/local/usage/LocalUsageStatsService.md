...
type: code-source
language: kotlin
file_path: android-app/app/src/main/java/fr/datasaillance/nightfall/data/local/usage/LocalUsageStatsService.kt
git_blob: a4e7d4ad07f08faec8d74bf99662f31d18ad1c41
...
# android-app/app/src/main/java/fr/datasaillance/nightfall/data/local/usage/LocalUsageStatsService.kt

> [!info] Code mirror
> Ce fichier est un **miroir auto-généré** de [`android-app/app/src/main/java/fr/datasaillance/nightfall/data/local/usage/LocalUsageStatsService.kt`](../../../android-app/app/src/main/java/fr/datasaillance/nightfall/data/local/usage/LocalUsageStatsService.kt).
...
### Symbols
- `UsageStatsSource` (class) — lines 16-19
- `queryUsageStats` (function) — lines 18-18
- `AndroidUsageStatsSource` (class) — lines 25-28
- `queryUsageStats` (function) — lines 26-27
- `LocalUsageStatsService` (class) — lines 39-121
- `collectDailyStats` (function) — lines 50-101
- `backfillDays` (function) — lines 107-116
