...
> [!info] Code mirror
> Ce fichier est un **miroir auto-généré** de [`android-app/app/src/native/java/fr/datasaillance/nightfall/ui/screens/sleep/HypnogramStatsSection.kt`](../../../android-app/app/src/native/java/fr/datasaillance/nightfall/ui/screens/sleep/HypnogramStatsSection.kt).
...
### Symbols
- `HypnogramStatsSection` (function) — lines 17-75
- `StageInfo` (class) — lines 27-27
- `StageStatRow` (function) — lines 77-107
