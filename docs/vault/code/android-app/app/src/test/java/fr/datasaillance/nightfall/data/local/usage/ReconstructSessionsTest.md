...
type: code-source
language: kotlin
file_path: android-app/app/src/test/java/fr/datasaillance/nightfall/data/local/usage/ReconstructSessionsTest.kt
git_blob: f918c3747935c8bf410242c973f0dc1a45a14109
...
# android-app/app/src/test/java/fr/datasaillance/nightfall/data/local/usage/ReconstructSessionsTest.kt

> [!info] Code mirror
> Ce fichier est un **miroir auto-généré** de [`android-app/app/src/test/java/fr/datasaillance/nightfall/data/local/usage/ReconstructSessionsTest.kt`](../../../android-app/app/src/test/java/fr/datasaillance/nightfall/data/local/usage/ReconstructSessionsTest.kt).
...
### Symbols
- `ReconstructSessionsTest` (class) — lines 11-159
- `ev` (function) — lines 15-15
- `ta1_simple_session_resumed_then_paused` (function) — lines 18-32
- `ta2_open_session_closed_at_toMs` (function) — lines 35-43
- `ta3_keyguard_shown_closes_all_open_sessions` (function) — lines 46-61
- `ta4_orphan_paused_ignored` (function) — lines 64-69
- `ta5_consecutive_resumed_without_paused` (function) — lines 72-87
- `ta8_three_separate_sessions_no_continuous_arc` (function) — lines 90-109
- `close_by_activity_stopped_type23` (function) — lines 112-121
- `screen_off_type14_closes_all` (function) — lines 124-134
- `zero_duration_session_filtered` (function) — lines 137-145
- `unsorted_events_are_sorted_first` (function) — lines 148-158
