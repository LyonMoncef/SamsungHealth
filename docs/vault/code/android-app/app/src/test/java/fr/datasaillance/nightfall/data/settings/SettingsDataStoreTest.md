...
type: code-source
language: kotlin
file_path: android-app/app/src/test/java/fr/datasaillance/nightfall/data/settings/SettingsDataStoreTest.kt
git_blob: 9a43a5839233680c4787615e5b54f6ee095cc102
...
> [!info] Code mirror
> Ce fichier est un **miroir auto-généré** de [`android-app/app/src/test/java/fr/datasaillance/nightfall/data/settings/SettingsDataStoreTest.kt`](../../../android-app/app/src/test/java/fr/datasaillance/nightfall/data/settings/SettingsDataStoreTest.kt).
...
### Symbols
- `SettingsDataStoreTest` (class) — lines 19-211
- `setUp` (function) — lines 26-34
- `getBackendUrl_returnsEmulatorDefault_whenNeverSet` (function) — lines 38-54
- `setBackendUrl_persistsAndIsReadableViaGetBackendUrl` (function) — lines 57-68
- `setBackendUrl_httpPrefix_isAccepted` (function) — lines 71-87
- `setBackendUrl_ftpPrefix_throwsIllegalArgumentException` (function) — lines 91-96
- `setBackendUrl_emptyString_throwsIllegalArgumentException` (function) — lines 99-103
- `setBackendUrl_noScheme_throwsIllegalArgumentException` (function) — lines 106-110
- `getThemePreference_returnsSystemByDefault` (function) — lines 114-125
- `setThemePreference_dark_persistsAndIsReadable` (function) — lines 128-138
- `setThemePreference_light_persistsAndIsReadable` (function) — lines 141-151
- `setThemePreference_system_persistsAndIsReadable` (function) — lines 154-165
- `setThemePreference_invalidValue_throwsIllegalArgumentException` (function) — lines 169-173
- `setThemePreference_emptyString_throwsIllegalArgumentException` (function) — lines 176-180
- `setThemePreference_auto_throwsIllegalArgumentException` (function) — lines 183-187
- `settingsDataStore_usesDistinctPrefsFile_fromTokenDataStore` (function) — lines 191-210
