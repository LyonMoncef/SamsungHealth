...
type: code-source
language: kotlin
file_path: android-app/app/src/test/java/fr/datasaillance/nightfall/ui/screens/hypnogram/HypnogramScreenTest.kt
git_blob: 8babc9a383c1494a401bc7aef00c02cd7e9c2f97
...
> [!info] Code mirror
> Ce fichier est un **miroir auto-généré** de [`android-app/app/src/test/java/fr/datasaillance/nightfall/ui/screens/hypnogram/HypnogramScreenTest.kt`](../../../android-app/app/src/test/java/fr/datasaillance/nightfall/ui/screens/hypnogram/HypnogramScreenTest.kt).
...
### Symbols
- `injectSleepState` (function) — lines 111-120
- `HypnogramScreenSnapshotTest` (class) — lines 127-189
- `buildViewModel` (function) — lines 135-138
- `hypnogramScreen_full_session_dark` (function) — lines 142-163
- `hypnogramScreen_full_session_light` (function) — lines 167-188
- `HypnogramScreenInteractionTest` (class) — lines 196-504
- `buildViewModel` (function) — lines 202-205
- `hypnogramScreen_nav_dest_route_is_correct` (function) — lines 210-227
- `hypnogramScreen_back_button_invokes_callback` (function) — lines 231-263
- `hypnogramScreen_canvas_visible_when_stages_present` (function) — lines 267-290
- `hypnogramScreen_legend_shows_all_four_stage_types` (function) — lines 294-337
- `hypnogramScreen_kpis_show_correct_total_duration` (function) — lines 341-369
- `hypnogramScreen_kpis_show_correct_deep_duration` (function) — lines 373-396
- `hypnogramScreen_not_found_when_session_id_invalid` (function) — lines 400-428
- `hypnogramScreen_no_stages_state_when_stages_null` (function) — lines 432-460
- `hypnogramScreen_legend_omits_absent_stage_types` (function) — lines 465-503
- `BuildSegmentsTest` (class) — lines 511-730
- `buildSegments_fills_gaps_with_awake` (function) — lines 515-558
- `buildSegments_no_gap_if_stages_contiguous` (function) — lines 562-603
- `buildSegments_adds_awake_at_start_if_first_stage_late` (function) — lines 607-649
- `buildSegments_adds_awake_at_end_if_last_stage_early` (function) — lines 653-680
- `buildSegments_returns_ordered_segments` (function) — lines 684-729
