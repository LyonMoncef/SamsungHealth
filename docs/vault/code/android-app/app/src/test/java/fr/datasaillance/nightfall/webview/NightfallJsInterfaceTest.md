...
type: code-source
language: kotlin
file_path: android-app/app/src/test/java/fr/datasaillance/nightfall/webview/NightfallJsInterfaceTest.kt
git_blob: 7e45b3133b4a53ba2d76ebfe151a939fad695e37
...
> [!info] Code mirror
> Ce fichier est un **miroir auto-généré** de [`android-app/app/src/test/java/fr/datasaillance/nightfall/webview/NightfallJsInterfaceTest.kt`](../../../android-app/app/src/test/java/fr/datasaillance/nightfall/webview/NightfallJsInterfaceTest.kt).
...
### Symbols
- `NightfallJsInterfaceTest` (class) — lines 24-185
- `setUp` (function) — lines 31-35
- `getAppVersion_returnsNonEmptyVersionName` (function) — lines 39-52
- `getAppVersion_returnsBuildConfigVersionName` (function) — lines 55-69
- `openImport_triggersOnOpenImportCallback` (function) — lines 73-87
- `openImport_triggersCallback_afterLooperIdle` (function) — lines 90-104
- `onNightfallEvent_validJson_doesNotThrow` (function) — lines 107-122
- `onNightfallEvent_emptyString_doesNotThrow` (function) — lines 125-139
- `onNightfallEvent_malformedJson_doesNotThrow` (function) — lines 142-156
- `jsInterface_exposesExpectedPublicMethods` (function) — lines 161-184
