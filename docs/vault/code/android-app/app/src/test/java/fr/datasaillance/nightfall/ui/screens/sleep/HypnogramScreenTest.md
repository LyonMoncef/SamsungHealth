...
> [!info] Code mirror
> Ce fichier est un **miroir auto-généré** de [`android-app/app/src/test/java/fr/datasaillance/nightfall/ui/screens/sleep/HypnogramScreenTest.kt`](../../../android-app/app/src/test/java/fr/datasaillance/nightfall/ui/screens/sleep/HypnogramScreenTest.kt).
...
### Symbols
- `injectHypnogramState` (function) — lines 102-111
- `HypnogramScreenSnapshotTest` (class) — lines 118-222
- `buildViewModel` (function) — lines 126-132
- `hypnogramScreen_success_dark` (function) — lines 136-154
- `hypnogramScreen_success_light` (function) — lines 159-177
- `hypnogramScreen_loading_dark` (function) — lines 181-199
- `hypnogramScreen_error_dark` (function) — lines 203-221
- `HypnogramScreenInteractionTest` (class) — lines 236-486
- `buildViewModel` (function) — lines 242-248
- `hypnogramScreen_shows_canvas` (function) — lines 252-274
- `hypnogramScreen_shows_night_title` (function) — lines 279-302
- `hypnogramScreen_shows_stats_section` (function) — lines 306-328
- `hypnogramScreen_shows_loading` (function) — lines 332-359
- `hypnogramScreen_shows_error_with_retry` (function) — lines 363-390
- `hypnogramScreen_stages_null_shows_canvas_placeholder` (function) — lines 393-421
- `hypnogramScreen_zero_duration_does_not_crash` (function) — lines 424-458
- `hypnogramScreen_back_button_calls_onBack` (function) — lines 461-485
- `HypnogramViewModelTest` (class) — lines 499-612
- `setUp` (function) — lines 505-515
- `tearDown` (function) — lines 517-520
- `hypnogramViewModel_emits_success_when_session_found` (function) — lines 525-544
- `hypnogramViewModel_emits_error_when_session_not_found` (function) — lines 550-568
- `hypnogramViewModel_emits_error_when_repository_fails` (function) — lines 574-592
- `hypnogramViewModel_emits_loading_while_in_flight` (function) — lines 597-611
