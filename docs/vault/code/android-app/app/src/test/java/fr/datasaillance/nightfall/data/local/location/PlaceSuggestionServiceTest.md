...
type: code-source
language: kotlin
file_path: android-app/app/src/test/java/fr/datasaillance/nightfall/data/local/location/PlaceSuggestionServiceTest.kt
git_blob: e1c96c405279588aafd06f7b25570910a0414792
...
# android-app/app/src/test/java/fr/datasaillance/nightfall/data/local/location/PlaceSuggestionServiceTest.kt

> [!info] Code mirror
> Ce fichier est un **miroir auto-généré** de [`android-app/app/src/test/java/fr/datasaillance/nightfall/data/local/location/PlaceSuggestionServiceTest.kt`](../../../android-app/app/src/test/java/fr/datasaillance/nightfall/data/local/location/PlaceSuggestionServiceTest.kt).
...
### Symbols
- `PlaceSuggestionServiceTest` (class) — lines 11-68
- `visit` (function) — lines 13-25
- `cluster_below_threshold_is_not_suggested` (function) — lines 27-35
- `cluster_at_threshold_becomes_suggestion_with_centroid_and_count` (function) — lines 37-53
- `far_apart_visits_form_separate_clusters` (function) — lines 55-62
- `empty_visits_returns_empty` (function) — lines 64-67
