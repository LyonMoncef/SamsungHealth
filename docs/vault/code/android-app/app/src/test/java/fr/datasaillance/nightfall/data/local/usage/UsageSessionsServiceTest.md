...
type: code-source
language: kotlin
file_path: android-app/app/src/test/java/fr/datasaillance/nightfall/data/local/usage/UsageSessionsServiceTest.kt
git_blob: 1b7e1b966e9a93d3ddb6b36d3f55b913d1f00153
...
# android-app/app/src/test/java/fr/datasaillance/nightfall/data/local/usage/UsageSessionsServiceTest.kt

> [!info] Code mirror
> Ce fichier est un **miroir auto-généré** de [`android-app/app/src/test/java/fr/datasaillance/nightfall/data/local/usage/UsageSessionsServiceTest.kt`](../../../android-app/app/src/test/java/fr/datasaillance/nightfall/data/local/usage/UsageSessionsServiceTest.kt).
...
### Symbols
- `FakeUsageEventsSource` (class) — lines 17-20
- `queryEvents` (function) — lines 18-19
- `UsageSessionsServiceTest` (class) — lines 22-132
- `setUp` (function) — lines 27-33
- `tearDown` (function) — lines 35-36
- `ta7_date_derived_from_start_ms_in_device_zone` (function) — lines 39-62
- `collect_persists_reconstructed_sessions` (function) — lines 64-82
- `collect_is_idempotent_on_rerun` (function) — lines 84-99
- `collect_returns_zero_when_no_events` (function) — lines 101-112
- `backfill_collects_multiple_days` (function) — lines 114-131
