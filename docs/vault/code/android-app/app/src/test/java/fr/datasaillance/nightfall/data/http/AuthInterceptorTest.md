...
type: code-source
language: kotlin
file_path: android-app/app/src/test/java/fr/datasaillance/nightfall/data/http/AuthInterceptorTest.kt
git_blob: a709a17c4785f50528383c60fc2e9c131b17c7b9
...
# android-app/app/src/test/java/fr/datasaillance/nightfall/data/http/AuthInterceptorTest.kt

> [!info] Code mirror
> Ce fichier est un **miroir auto-généré** de [`android-app/app/src/test/java/fr/datasaillance/nightfall/data/http/AuthInterceptorTest.kt`](../../../android-app/app/src/test/java/fr/datasaillance/nightfall/data/http/AuthInterceptorTest.kt).
...
### Symbols
- `AuthInterceptorTest` (class) — lines 21-124
- `setUp` (function) — lines 26-32
- `tearDown` (function) — lines 34-37
- `authInterceptor_addsBearer` (function) — lines 41-65
- `authInterceptor_noToken_noHeader` (function) — lines 69-92
- `authInterceptor_addsBearer_onEveryRequest` (function) — lines 95-123
