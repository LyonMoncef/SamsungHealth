...
> [!info] Code mirror
> Ce fichier est un **miroir auto-généré** de [`server/security/rgpd.py`](../../../server/security/rgpd.py).
...
### Implements specs
- [[../../specs/2026-04-28-phase3-rgpd-endpoints]] — symbols: `build_user_export_zip`, `erase_user_cascade`, `_anonymize_auth_events`, `_safe_audit_event`, `EraseStats`

### Symbols
- `ExportRequestIn` (class) — lines 95-97
- `ExportRequestOut` (class) — lines 100-102
- `EraseRequestIn` (class) — lines 105-107
- `EraseRequestOut` (class) — lines 110-112
- `EraseConfirmIn` (class) — lines 115-116
- `EraseStats` (class) — lines 119-121 · **Specs**: [[../../specs/2026-04-28-phase3-rgpd-endpoints|2026-04-28-phase3-rgpd-endpoints]]
- `AuditEventOut` (class) — lines 124-131
- `AuditLogPage` (class) — lines 134-138
- `_verify_oauth_nonce` (function) — lines 144-151
- `_verify_reauth` (function) — lines 154-186
- `_trigger_soft_backoff` (function) — lines 189-200
- `_ip_hmac` (function) — lines 206-224
- `_create_verification_token` (function) — lines 230-269
- `_consume_verification_token_atomic` (function) — lines 272-315
- `_safe_audit_event` (function) — lines 321-350 · **Specs**: [[../../specs/2026-04-28-phase3-rgpd-endpoints|2026-04-28-phase3-rgpd-endpoints]]
- `_anonymize_auth_events` (function) — lines 353-371 · **Specs**: [[../../specs/2026-04-28-phase3-rgpd-endpoints|2026-04-28-phase3-rgpd-endpoints]]
- `_row_to_serializable` (function) — lines 377-401
- `_stringify_for_csv` (function) — lines 404-415
- `_orm_class_for_table` (function) — lines 418-426
- `_write_table_to_zip` (function) — lines 429-484
- `build_user_export_zip` (function) — lines 487-591 · **Specs**: [[../../specs/2026-04-28-phase3-rgpd-endpoints|2026-04-28-phase3-rgpd-endpoints]]
- `erase_user_cascade` (function) — lines 597-664 · **Specs**: [[../../specs/2026-04-28-phase3-rgpd-endpoints|2026-04-28-phase3-rgpd-endpoints]]
