...
type: code-source
language: python
file_path: server/security/audit.py
git_blob: 4b60fa91d093e54724fc76c87c8fac3ecee7905a
...
> [!info] Code mirror
> Ce fichier est un **miroir auto-généré** de [`server/security/audit.py`](../../../server/security/audit.py).
...
### Symbols
- `_truncate_meta` (function) — lines 30-68
- `audit_event` (function) — lines 71-105
