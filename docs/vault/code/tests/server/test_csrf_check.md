...
> [!info] Code mirror
> Ce fichier est un **miroir auto-généré** de [`tests/server/test_csrf_check.py`](../../../tests/server/test_csrf_check.py).
...
### Symbols
- `TestSecFetchSiteCheck` (class) — lines 43-162
...
- [[../../specs/2026-04-27-v2.3.3.2-frontend-nightfall]] — classes: `TestSecFetchSiteCheck`
