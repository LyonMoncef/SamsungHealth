...
> [!info] Code mirror
> Ce fichier est un **miroir auto-généré** de [`tests/server/test_healthz.py`](../../../tests/server/test_healthz.py).
...
### Symbols
- `TestHealthz` (class) — lines 13-18
- `TestReadyz` (class) — lines 21-98
...
- [[../../specs/2026-04-30-phase6-cicd-mvp]] — classes: `TestHealthz`, `TestReadyz`
