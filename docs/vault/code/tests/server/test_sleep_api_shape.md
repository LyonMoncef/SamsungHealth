...
type: code-source
language: python
file_path: tests/server/test_sleep_api_shape.py
git_blob: c9cc828e5d2abbbe435f58b76202eac71750757c
...
> [!info] Code mirror
> Ce fichier est un **miroir auto-généré** de [`tests/server/test_sleep_api_shape.py`](../../../tests/server/test_sleep_api_shape.py).
...
### Symbols
- `test_sleep_response_fields` (function) — lines 32-44
- `test_sleep_stages_fields` (function) — lines 47-55
- `test_sleep_stages_empty_without_flag` (function) — lines 58-63
- `test_sleep_iso_strings_parseable` (function) — lines 66-77
- `test_sleep_ordered_by_start` (function) — lines 80-86
- `test_sleep_date_range_filter` (function) — lines 89-94
- `test_sleep_empty_db_returns_list` (function) — lines 97-101
