...
> [!info] Code mirror
> Ce fichier est un **miroir auto-généré** de [`tests/server/test_postgres_bootstrap.py`](../../../tests/server/test_postgres_bootstrap.py).
...
### Symbols
- `_run_alembic` (function) — lines 43-52
- `TestBootstrap` (class) — lines 55-108
...
- [[../../specs/2026-04-24-v2-postgres-migration]] — classes: `TestBootstrap` · methods: `test_alembic_upgrade_creates_schema`, `test_alembic_idempotent`, `test_alembic_downgrade_reverses`
