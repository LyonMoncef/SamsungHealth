...
- _client
- TestPagesServed
- TestCspDifferentiated
- TestSecurityHeadersGlobal
- TestHstsConditional
- TestCacheControl
- TestServerHeaderStripped
- TestNoInlineStyleScript
- TestNoDangerousJs
- TestNoExternalResources
- TestNoTokenLeakInHtml
tags:
- code
- python
---
...
> [!info] Code mirror
> Ce fichier est un **miroir auto-généré** de [`tests/server/test_static_auth_pages.py`](../../../tests/server/test_static_auth_pages.py).
...
### Symbols
- `_client` (function) — lines 42-53
- `TestPagesServed` (class) — lines 57-74
- `TestCspDifferentiated` (class) — lines 78-126
- `TestSecurityHeadersGlobal` (class) — lines 130-187
- `TestHstsConditional` (class) — lines 191-231
- `TestCacheControl` (class) — lines 235-280
- `TestServerHeaderStripped` (class) — lines 284-319
- `TestNoInlineStyleScript` (class) — lines 323-373
- `TestNoDangerousJs` (class) — lines 377-412
- `TestNoExternalResources` (class) — lines 416-454
- `TestNoTokenLeakInHtml` (class) — lines 458-493
...
- [[../../specs/2026-04-27-v2.3.3.2-frontend-nightfall]] — classes: `TestPagesServed`, `TestCspDifferentiated`, `TestSecurityHeadersGlobal`, `TestHstsConditional`, `TestCacheControl`, `TestServerHeaderStripped`, `TestNoInlineStyleScript`, `TestNoDangerousJs`, `TestNoExternalResources`, `TestNoTokenLeakInHtml`
