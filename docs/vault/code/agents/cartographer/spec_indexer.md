...
- agents.contracts.spec
exports:
- load_spec
- build_index
- discover_spec_paths
- detect_implements_drift
- untested_specs
- _infer_language_for_walker
tags:
- code
- python
---
...
> [!info] Code mirror
> Ce fichier est un **miroir auto-généré** de [`agents/cartographer/spec_indexer.py`](../../../agents/cartographer/spec_indexer.py).
