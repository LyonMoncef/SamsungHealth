...
type: code-source
language: python
file_path: agents/mcp/bug_tracker/server.py
git_blob: b788c32d962ba153c73ba44e68b3de07bfeb6e1d
...
# agents/mcp/bug_tracker/server.py

> [!info] Code mirror
> Ce fichier est un **miroir auto-généré** de [`agents/mcp/bug_tracker/server.py`](../../../agents/mcp/bug_tracker/server.py).
...
### Symbols
- `_get_conn` (function) — lines 26-51
- `_write_markdown` (function) — lines 54-103
