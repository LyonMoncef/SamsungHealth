 ...
 * contenant les 3 CSV du contrat v1 et `manifest.json`, pour la copie vers le notebook.
 *
...
object ExportArchive {
    ...
    fun write(output: OutputStream, sleep: List<SleepRecord>, steps: List<StepsInterval>, manifest: ExportManifest) {
        val entries = listOf(
